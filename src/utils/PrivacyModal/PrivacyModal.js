										...
										>
											<div className="sc-bczRLJ sc-nrd8cx-0 sc-nrd8cx-1 hJYFVB fhPvJh frnZMK">
												<div className="sc-bczRLJ sc-nrd8cx-0 sc-nrd8cx-3 hJYFVB cTSGxd bORAza">
													...
													<div className="sc-sx9n2y-0 kcDJjM css-1aekuku">Privacy Policy</div>
												</div>
												<svg
													xmlns="http://www.w3.org/2000/svg"
													width={20}
								...
								<div className="sc-1kykgp9-2 kqyzGE">
									<div className="sc-bczRLJ sc-57i8km-0 sc-57i8km-3 hJYFVB hqshMl eftBvH">
										<div className="sc-1kykgp9-2 hinRyL">
											<div className="sc-bczRLJ sc-nrd8cx-0 sc-nrd8cx-3 hJYFVB cTSGxd bORAza">
												...
												<div className="sc-sx9n2y-0 EngNh css-1aekuku">Auto Router</div>
											</div>
											<div className="sc-sx9n2y-0 bqwbXT css-1aekuku">
									...
									<div className="sc-bczRLJ sc-57i8km-0 sc-57i8km-3 hJYFVB hqshMl eftBvH">
										<div className="sc-1kykgp9-2 hinRyL">
											...
											<div className="sc-sx9n2y-0 bqwbXT css-1aekuku">
												The app fetches on-chain data and constructs contract calls with an Infura
												API.
											</div>
										</div>
									</div>
									<div className="sc-bczRLJ sc-57i8km-0 sc-57i8km-3 hJYFVB hqshMl eftBvH">
										<div className="sc-1kykgp9-2 hinRyL">
											...
											<div className="sc-sx9n2y-0 bqwbXT css-1aekuku">
												The app securely collects your wallet address and shares it with TRM Labs
												Inc. for risk and compliance reasons.{' '}
												<a
													target="_blank"
													rel="noopener noreferrer"
