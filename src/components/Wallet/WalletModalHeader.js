...
export default function WalletModalHeader({
  onConfigClick,
  closeHandler,
  theme,
}) {
  ...
  const [hoverAddress, setHoverAddress] = React.useState(true);
  ...
  return (
    <div
      width="100%"
      className="sc-bczRLJ sc-nrd8cx-0 sc-nrd8cx-3 laNPNA fsgYBU"
    >
      {senderPublicKey ? (
        <CopyToClipboard
            ...
            {hoverAddress ? (
              ...
              >
                {addressCopied ? (
                  ...
                  >
                    <path
                      fill={theme === "light" ? "#000000" : "#7f9bd4"}
                      fillRule="evenodd"
                  ...
                  >
                    <g clipPath="url(#clip0_5_1870)">
                      <path
                        ...
                        stroke={theme === "light" ? "#000000" : "#7f9bd4"}
                        strokeWidth="1.3"
                        strokeLinecap="round"
