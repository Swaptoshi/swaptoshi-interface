...
const Nfts = ({
  ...
  const handleTableClick = (tab) => {
    setSelectedTab(tab);
    const allTableData =
      selectedCurrencyTab === "USD" ? allTableDataUSD : allTableDataETH;
              ...
              <div className="sc-oqttp6-0 aYNfB">
                <div className="sc-oqttp6-1 jXnpsx">
                  <Slider {...settings}>
                    ...
                    {/* Slider - Two */}
                    <div
                      className="sc-oqttp6-2 fNoRxi slider2"
                ...
                <thead className="ntfs-t-head   rgw6ez7ar">
                  <tr role="row">
                    ...
                    >
                      ...
                      <span className="_1klryar0 rgw6ez2cp col-tab">
                        Collection name
                      </span>
                    </th>
                    <th
                    ...
                    >
                      ...
                      <span className="_1klryar0 rgw6ez2cp floor-change-table">
                        Floor change
                      </span>
                    </th>
                    <th
                    ...
                    >
                      ...
                      <span className="_1klryar0 rgw6ez2ed volume-table">
                        Volume
                      </span>
                    </th>
                    <th
                    ...
                    >
                      ...
                      <span className="_1klryar0 rgw6ez2cp volume-change-table">
                        Volume change
                      </span>
                    </th>
                    <th
                    ...
                    >
                      ...
                      <span className="_1klryar0 rgw6ez2cp items-table">
                        Items
                      </span>
                    </th>
                    <th
                    ...
                    >
                      ...
                      <span className="_1klryar0 rgw6ez2cp owner-table">
                        Owners
                      </span>
                    </th>
                  </tr>
                ...
                <tbody role="rowgroup">
                  {tableData.map((item, index) => (
                    <tr
                      ...
                      onClick={() =>
                        navigate(
                          `/nfts/${item.id}?currency=${selectedCurrencyTab}`
                        )
                      }
                    ...
                    >
                      ...
                      >
                        <div className="sc-iwpsza-0 jNQukZ">
                          <div className="sc-sx9n2y-0 bftkTM css-1cjl26j">
                            {index + 1}
                          </div>
