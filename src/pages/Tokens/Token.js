...
const Token = ({ allTableData, updateTime, options }) => {
  ...
  useEffect(() => {
    const filteredData = allTableData.filter(
      (data) => data.label === selectedOption.label
    );
            ...
            <div className="filter-dropdowns">
                ...
                <div className="token-update">
                  ...
                  >
                    <div className="token-update-text">
                      {updateOption.label}
                      <span
                        className={`icon-drop ${handleOpen ? "rotated" : ""}`}
                      >
                        <i className="ri-arrow-down-s-line"></i>
                      </span>
                    </div>
              ...
              >
                <NavLink
                  ...
                  to="/create-token"
                >
                  <PrimaryButton style={{ width: "130px" }}>
                    Create Token
                  </PrimaryButton>
                </NavLink>

                <NavLink
                  className="show-below-375 hide-above-375"
                  to="/create-token"
                >
            ...
            <div className="sc-19z0ycm-1 ejgNi">
              {filteredTableData.map((data, index) => (
                <div key={data.id} data-testid="token-table-row-NATIVE">
                  <Link
                    className="sc-1bit9h6-16 kiPA-dv"
                    to={`/tokens/${data.id}`}
                  >
                    <div className="sc-1bit9h6-1 cQmpaP">
                      <div className="sc-1bit9h6-0 sc-1bit9h6-5 hJyIyF bwVaNf">
                        {index + 1}
                      </div>
                      <div
                        data-testid="name-cell"
                      ...
                      >
                        <div className="sc-1bit9h6-2 sc-1bit9h6-3 bvHTKj jqxpYK">
                          ...
                          <div className="sc-1bit9h6-0 sc-1bit9h6-17 hJyIyF gKCxsP">
                            <div
                              data-cy="token-name"
                              className="sc-1bit9h6-18 kSNzln"
                            >
                              {data.name}
                            </div>
                      ...
                      >
                        <div className="sc-1bit9h6-2 bvHTKj">
                          ...
                          <span className="sc-1nu6e54-2 braSjM">
                            <span>
                              {determineTrendIcon(data.price, data.oldPrice)}
                            </span>
                            <span
                              className=""
                              style={{
